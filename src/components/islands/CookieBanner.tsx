  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-white/30">
          <a
            href="/politica-de-privacidade"
            className="font-sans transition-colors hover:text-white/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
          >
